...
class CActualizaciones5 extends CI_Controller {

  function __construct(){
		parent::__construct();
		$this->load->model('MAct5');
  ...
  function ajaxConsumo(){
    ...
    $this->MAct5->insConsumoFamiliar($arr_consumo);


  }

	public function sociales($alumno){
    ...
    $this->MAct5->DelMovil($alumno);
    $this->MAct5->insertMovil($arr_int);
    ...
    $this->MAct5->delRelaciones($alumno);
    $id_realacion=$this->MAct5->insRelaciones($arr_relaciones);
    $relacion=$id_realacion->id_relacion;

    $this->MAct5->delRelHerano($relacion);
    if (isset($_POST['plat'])) {
      $arr_relacion=array(
        "relacion"=>$relacion,
        "descripcion"=>1);
      $this->MAct5->insRelHerano($arr_relacion);
    }
    ...
    $this->MAct5->delActFamilia($relacion);
    ...
    if (isset($_POST['lavarpapa'])) {
      $ar_actividades=array(
        ...
        "actividad"=>14,
        "familiar"=>1);
      $this->MAct5->insertActFamilia($ar_actividades);
    }
    ...
    $this->MAct5->delNegocio($relacion);
    if (isset($_POST['negocio'])) {
      $ar_actividades=array(
        "relacion"=>$relacion,
        "actividades_apoyo"=>$_POST['negocio2']);
      $this->MAct5->insertNegocio($ar_actividades);
    }
