<div class="row">
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s6"><a href="#proyecto">Proyecto de vida</a></li>
				<li class="tab col s6"><a href="#perfil">Perfil personal y académico de los estudiantes</a></li>
      </ul>
    </div>


<div class="container">
<div id="proyecto" class="col s12">
  <div class="row">
