<div class="row">
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s6"><a href="#socioeconomico">Ambiente socioeconómico</a></li>
				<li class="tab col s6"><a href="#sal">Salud</a></li>
      </ul>
    </div>


<div class="container">
<div id="socioeconomico" class="col s12">
