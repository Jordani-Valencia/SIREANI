<div class="row">
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s2"><a href="#ejerDepor">Ejercicio y Deportes</a></li>
				<li class="tab col s2"><a href="#consumo">Hábitos de consumo</a></li>
        <li class="tab col s3"><a href="#libre">Recreación y tiempo libre</a></li>
        <li class="tab col s2"><a href="#gusInt">Gustos e Intereses</a></li>
        <li class="tab col s3"><a href="#partInt">Participación Social e Internet</a></li>
      </ul>
    </div>


<div class="container">
<div id="ejerDepor" class="col s12">
