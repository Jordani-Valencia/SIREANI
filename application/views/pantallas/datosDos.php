<div class="row">
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s4"><a href="#dMadre">Datos de la madre</a></li>
				<li class="tab col s4"><a href="#dPadre">Datos del padre</a></li>
        <li class="tab col s4"><a href="#ingresos">Ingresos familiares</a></li>
      </ul>
    </div>


<div class="container">
<div id="dMadre" class="col s12">
