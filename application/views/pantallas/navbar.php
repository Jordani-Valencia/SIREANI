<div class="row orange lighten-2">
	<ul id="slide-out" class="sidenav">
      <li><a href="<?php echo base_url();?>admin/adminUno">Datos generales, Domicilio del alumno y Datos familiares</a></li>
      <li><a href="<?php echo base_url();?>admin/adminDos">Domicilio del alumno</a></li>
    </ul>
